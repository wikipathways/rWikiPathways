...
tools to the research community for content creation, editing and utilization.
...
standardized identifier form an official source. WikiPathways relies on BridgeDb to 
...
Let's assume we identified 'WP554', the Ace Inhibitor Pathway (https://www.wikipathways.org/index.php/Pathway:WP554). We will use its WPID (WP554)
